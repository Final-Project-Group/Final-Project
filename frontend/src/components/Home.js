            ...
            <li className="profile-li">
              ...
              >
                ...
                >
                  ...
                  <Typography
                    className="home-event-info"
                    color="textPrimary"
                    style={{
                      backgroundImage: "linear-gradient(rgb(75,105,40), black)",
                    }}
                  >
                    <div className="home-event-info-row">
                      <span
                        lassName="home-event-span"
                        style={{ color: "white" }}
                      >
                        Creator <br /> {event.creator.name}
                      </span>
                      <span style={{ color: "white" }}>
                        Spots <br /> {event.spots - event.members.length}/
                        {event.spots}
                      </span>
                    </div>
                    <div className="home-event-info-middle"></div>
                  </Typography>
                </Card>
              </Link>
            </li>
  ...
  return (
    <div className="home-container">
      ...
      <div className="home-container-event-list">
        <ul className="home-events-ul">{showEvents()}</ul>
      </div>
